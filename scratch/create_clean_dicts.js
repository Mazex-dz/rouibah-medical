...
const fr = {
    ...
    'contact-title': 'Nous sommes là pour vous aider <span class="text-teal">et répondre à vos questions</span>',
...
const ar = {
    ...
    'contact-title': 'نحن هنا للمساعدة <span class="text-teal">والإجابة على استفساراتك</span>',
...
fs.writeFileSync('scratch/fr_clean.json', JSON.stringify(fr, null, 2));
fs.writeFileSync('scratch/ar_clean.json', JSON.stringify(ar, null, 2));
console.log('Cleaned translation dictionaries created');
