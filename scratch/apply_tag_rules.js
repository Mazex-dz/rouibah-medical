...
// Tag mapping for all elements by matching their exact text or key landmark
const tagRules = [
  ...
  { key: 'why-title', search: 'ما يجعلنا الخيار' },
  ...
  { key: 'doctors-title', search: 'أطباء متخصصون' },
  ...
  { key: 'apt-title', search: 'احجز موعدك الآن' },
  ...
  { key: 'btn-submit-apt', search: 'تأكيد طلب الحجز' },

  { key: 'gallery-tag', search: 'معرض العيادة' },
  { key: 'gallery-title', search: 'جولة مصورة' },
  { key: 'testi-tag', search: 'آراء المرضى' },
  { key: 'testi-title', search: 'ماذا يقول مرضانا' },
  { key: 'contact-tag', search: 'تواصل معنا' },
  { key: 'contact-title', search: 'نحن هنا للمساعدة' },
  { key: 'c-addr-title', search: 'عنوان العيادة' },
  { key: 'c-addr-val', search: 'برج منايل، ولاية بومرداس، الجزائر' },
  { key: 'c-phone-title', search: 'الهاتف والاستعجالات' },
  { key: 'c-hours-title', search: 'أوقات العمل' },
  { key: 'c-hours-val', search: '7 أيام / 7 - 24 ساعة / 24 (استعجالات مستمرة)' },

  { key: 'footer-desc', search: 'عيادة الرويبح — مركزك الطبي الموثوق في برج منايل' },
